  ...
  return (
    <Stack px={[2, 4, 6, 8]} gap={4}>
      ...
      <Stack borderTop={"1px solid"} py={2} gap={4}>
        ...
        <Card5 data={data.filter((item) => item.category === "buissness")[0]} />
        <Grid
          templateColumns={["1fr", "1fr", "repeat(2,1fr)", "repeat(4,1fr)"]}
          gap={6}
        >
      ...
      <Stack borderTop={"1px solid"} py={2} gap={4}>
        ...
        <Card5b data={data.filter((item) => item.category === "culture")[0]} />
        <Grid
          templateColumns={["1fr", "1fr", "repeat(2,1fr)", "repeat(4,1fr)"]}
          gap={6}
        >
      ...
      <Stack borderTop={"1px solid"} py={2} gap={4} position={"relative"}>
        ...
        <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} py={4} gap={4}>
          <Card2b data={data.filter((item) => item.category === "travel")[0]} />
          <Card2b data={data.filter((item) => item.category === "travel")[3]} />
        </Grid>
